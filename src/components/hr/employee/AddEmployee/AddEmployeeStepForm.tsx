...
const financialValidationSchema = Yup.object({
  financialData: Yup.object({
    tin: Yup.string()
      .optional()
      .matches(/^\d{10}$/, "TIN must be 10 digits"),
...
export const AddEmployeeStepForm: React.FC<AddEmployeeStepFormProps> = ({
  ...
  const removeEmergencyContact = (
    ...
    const { values, setFieldValue } = formikProps;
    const updatedContacts = values.emergencyContacts.filter(
      (_, i) => i !== index
    );
  ...
  const renderStepContent = (
    ...
    const inputClassName = (fieldName: string) =>
      `w-full px-3 py-2 border focus:outline-none focus:border-green-500 focus:outline-2 rounded-md transition-colors duration-200 ${
        ...
        getNestedTouched(touched, fieldName)
          ? "border-red-500"
          : "border-gray-300"
      }`;
    ...
    switch (currentStep) {
      case 0:
        const filteredBranches = values.companyId
          ? getFilteredBranches(values.companyId)
          : [];
        const filteredDepartments = values.branchId
          ? getFilteredDepartments(values.branchId)
          : [];
        const filteredPositions = values.departmentId
          ? getFilteredPositions(values.departmentId)
          : [];
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleAmharicChange(e, "firstNameAm", setFieldValue)
                  }
                  onBlur={handleBlur}
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleAmharicChange(e, "middleNameAm", setFieldValue)
                  }
                  onBlur={handleBlur}
                  className="w-full px-3 py-2 border border-gray-300 focus:outline-none focus:border-green-500 focus:outline-2 rounded-md"
                  placeholder="በቀለ"
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleAmharicChange(e, "lastNameAm", setFieldValue)
                  }
                  onBlur={handleBlur}
            ...
            <div className="mt-8">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-3">
                ...
                <div className="space-y-2">
                  ...
                  >
                    <SelectTrigger
                      className={selectTriggerClassName("companyId")}
                    >
                ...
                <div className="space-y-2">
                  ...
                  >
                    <SelectTrigger
                      className={selectTriggerClassName("branchId")}
                    >
                ...
                <div className="space-y-2">
                  ...
                  >
                    <SelectTrigger
                      className={selectTriggerClassName("departmentId")}
                    >
                ...
                <div className="space-y-2">
                  ...
                  >
                    <SelectTrigger
                      className={selectTriggerClassName("positionId")}
                    >
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setFieldValue("jobGradeId", value)
                    }
                  >
                    <SelectTrigger
                      className={selectTriggerClassName("jobGradeId")}
                    >
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setFieldValue("employmentTypeId", value)
                    }
                  >
                    <SelectTrigger
                      className={selectTriggerClassName("employmentTypeId")}
                    >
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setFieldValue("employmentNatureId", value)
                    }
                  >
                    <SelectTrigger
                      className={selectTriggerClassName("employmentNatureId")}
                    >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                {getNestedError(errors, "biographicalData.birthLocation") &&
                  getNestedTouched(
                    touched,
                    "biographicalData.birthLocation"
                  ) && (
                    <div className="text-red-500 text-xs mt-1">
                      {getNestedError(errors, "biographicalData.birthLocation")}
                    </div>
              ...
              <div className="space-y-2">
                ...
                {getNestedError(errors, "biographicalData.motherFullName") &&
                  getNestedTouched(
                    touched,
                    "biographicalData.motherFullName"
                  ) && (
                    <div className="text-red-500 text-xs mt-1">
                      {getNestedError(
                        errors,
                ...
                >
                  <SelectTrigger
                    className={selectTriggerClassName(
                      "biographicalData.maritalStatusId"
                    )}
                  >
              ...
              <div className="space-y-2">
                ...
                >
                  <SelectTrigger
                    className={selectTriggerClassName(
                      "biographicalData.hasMarriageCert"
                    )}
                  >
                    <SelectValue placeholder="Select option" />
                  </SelectTrigger>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Select
                        ...
                        onValueChange={(value) =>
                          setFieldValue(
                            `emergencyContacts[${index}].addressId`,
                            value
                          )
                        }
                      >
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          handleAmharicChange(
                            e,
                            `familyMembers[${index}].firstNameAm`,
                            setFieldValue
                          )
                        }
                        className="w-full px-3 py-2 border border-gray-300 focus:outline-none focus:border-green-500 focus:outline-2 rounded-md"
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          handleAmharicChange(
                            e,
                            `familyMembers[${index}].middleNameAm`,
                            setFieldValue
                          )
                        }
                        className="w-full px-3 py-2 border border-gray-300 focus:outline-none focus:border-green-500 focus:outline-2 rounded-md"
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          handleAmharicChange(
                            e,
                            `familyMembers[${index}].lastNameAm`,
                            setFieldValue
                          )
                        }
                        className="w-full px-3 py-2 border border-gray-300 focus:outline-none focus:border-green-500 focus:outline-2 rounded-md"
                    ...
                    <div className="space-y-2">
                      ...
                      <Select
                        value={member.gender}
                        onValueChange={(value) =>
                          setFieldValue(`familyMembers[${index}].gender`, value)
                        }
                      >
                        <SelectTrigger className="w-full px-3 py-2 border border-gray-300 focus:outline-none focus:border-green-500 focus:outline-2 rounded-md">
                          <SelectValue placeholder="Select Gender" />
                    ...
                    <div className="space-y-2">
                      ...
                      <Select
                        ...
                        onValueChange={(value) =>
                          setFieldValue(
                            `familyMembers[${index}].relationId`,
                            value
                          )
                        }
                      >
          ...
          >
            ...
            <DocumentUploadSection
              ...
              onGuarantorFileSelect={(file) =>
                handleFileSelect(file, "guarantor", setFieldValue)
              }
              onStampFileSelect={(file) =>
                handleFileSelect(file, "stamp", setFieldValue)
              }
              onSignatureFileSelect={(file) =>
                handleFileSelect(file, "signature", setFieldValue)
              }
              onGuarantorFileRemove={() =>
                removeFile("guarantor", setFieldValue)
              }
              onStampFileRemove={() => removeFile("stamp", setFieldValue)}
              onSignatureFileRemove={() =>
                removeFile("signature", setFieldValue)
              }
            />
          </motion.div>
        );
              ...
              >
                ...
                <dl className="space-y-3">
                  ...
                  <div>
                    ...
                    <dd className="font-semibold text-gray-900">
                      {values.firstNameAm} {values.middleNameAm}{" "}
                      {values.lastNameAm}
                    </dd>
                  </div>
                  <div>
              ...
              >
                ...
                <dl className="space-y-3">
                  ...
                  <div>
                    ...
                    <dd className="font-semibold text-gray-900">
                      {mockEmploymentTypes.find(
                        (t) => t.id === values.employmentTypeId
                      )?.name || "Not selected"}
                    </dd>
                  </div>
                  <div>
                    ...
                    <dd className="font-semibold text-gray-900">
                      {mockEmploymentNatures.find(
                        (n) => n.id === values.employmentNatureId
                      )?.name || "Not selected"}
                    </dd>
                  </div>
                </dl>
              ...
              >
                ...
                <dl className="space-y-3">
                  <div>
                    ...
                    <dd className="font-semibold text-gray-900">
                      {values.biographicalData.birthDate}
                    </dd>
                  </div>
                  <div>
                    <dt className="text-xs font-medium text-gray-500 uppercase tracking-wide">
                    ...
                    <dd className="font-semibold text-gray-900">
                      {values.biographicalData.birthLocation}
                    </dd>
                  </div>
                  <div>
                    <dt className="text-xs font-medium text-gray-500 uppercase tracking-wide">
                    ...
                    <dd className="font-semibold text-gray-900">
                      {values.biographicalData.motherFullName}
                    </dd>
                  </div>
                  <div>
                    <dt className="text-xs font-medium text-gray-500 uppercase tracking-wide">
                  ...
                  <div>
                    ...
                    <dd className="font-semibold text-gray-900">
                      {values.biographicalData.hasBirthCert === "0"
                        ? "Yes"
                        : values.biographicalData.hasBirthCert === "1"
                        ? "No"
                        : "Not selected"}
                    </dd>
                  </div>
                  <div>
                    ...
                    <dd className="font-semibold text-gray-900">
                      {values.biographicalData.hasMarriageCert === "0"
                        ? "Yes"
                        : values.biographicalData.hasMarriageCert === "1"
                        ? "No"
                        : "Not selected"}
                    </dd>
                  </div>
                    ...
                    >
                      ...
                      <p className="text-xs text-gray-500">
                        ...
                        {contact.gender === "0"
                          ...
                          ? "Female"
                          : "Not selected"}{" "}
                        | Nationality: {contact.nationality} | Relation:{" "}
                        {mockRelations.find((r) => r.id === contact.relationId)
                          ?.name || "Not specified"}
                      </p>
                    </div>
                  ))}
                    ...
                    >
                      ...
                      <p className="text-xs text-gray-500">
                        ...
                        {member.gender === "0"
                          ...
                          ? "Female"
                          : "Not selected"}{" "}
                        | Nationality: {member.nationality} | Relation:{" "}
                        {mockRelations.find((r) => r.id === member.relationId)
                          ?.name || "Not specified"}
                      </p>
                    </div>
                  ))}
                    ...
                    >
                      ...
                      <p className="text-xs text-gray-500">
                        ...
                        {guarantor.gender === "0"
                          ...
                          ? "Female"
                          : "Not selected"}{" "}
                        | Nationality: {guarantor.nationality} | Relation:{" "}
                        {mockRelations.find(
                          (r) => r.id === guarantor.relationId
                        )?.name || "Not specified"}
                      </p>
                    </div>
                  ))}
