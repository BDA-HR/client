...
const LeavePolicyCard: React.FC<LeavePolicyCardProps> = ({
  ...
  const handleCardClick = () => {
    navigate(`/hr/settings/leavepolicy/${leavePolicy.id}`, {
      state: { leavePolicy }
    });
  };
          ...
          <>
            <div className="flex items-center mb-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-500">ID: {leavePolicy.id}</p>
              </div>
            </div>
          </>
        ) : (
            ...
            <div className="flex-1">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-1">ID: {leavePolicy.id}</p>
                </div>
              </div>
            </div>
          </>
