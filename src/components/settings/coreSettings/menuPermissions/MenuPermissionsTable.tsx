...
interface MenuPermissionTableProps {
  ...
  onEditPermission: (permission: PerMenuModDto) => void;
...
const MenuPermissionTable: React.FC<MenuPermissionTableProps> = ({
  ...
  const [selectedPermission, setSelectedPermission] = useState<PerMenuListDto | null>(null);
  const [activeModal, setActiveModal] = useState<'view' | 'delete' | null>(null);
  const [popoverOpen, setPopoverOpen] = useState<string | null>(null);

  const handleViewDetails = (permission: PerMenuListDto) => {
  ...
  const handleDelete = (permission: PerMenuListDto) => {
    setSelectedPermission(permission);
  ...
  const ViewPermissionModal: React.FC<{
    selectedPermission: PerMenuListDto | null;
    onClose: () => void;
              ...
              <div className="sm:flex sm:items-start">
                ...
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                  ...
                  <div className="mt-4 space-y-3">
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-500">Module ID</label>
                      <p className="mt-1 text-sm text-gray-900 bg-gray-50 p-2 rounded truncate">
                        {selectedPermission.perModuleId}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                  ...
                  <div className="mt-2">
                    <p className="text-sm text-gray-500">
                      Are you sure you want to delete the menu permission <span className="font-semibold">{permission.name}</span>?
