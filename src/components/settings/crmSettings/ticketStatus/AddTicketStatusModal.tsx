...
const AddTicketStatusModal: React.FC<AddTicketStatusModalProps> = ({
  isOpen,
  onClose,
  onSubmit
}) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError("Failed to add ticket status. Please try again.");
    } finally {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          <DialogTitle>Add Ticket Status</DialogTitle>
        </DialogHeader>
...
export default AddTicketStatusModal;
