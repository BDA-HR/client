...
import LeadActivities from '../../../components/crm/leadManagement/assignedLeads/LeadActivities';
import LeadNotes from '../../../components/crm/leadManagement/assignedLeads/LeadNotes';
import LeadHistory from '../../../components/crm/leadManagement/assignedLeads/LeadHistory';
import LeadCommunication from '../../../components/crm/leadManagement/assignedLeads/LeadCommunication';
import LeadScoring from '../../../components/crm/leadManagement/assignedLeads/LeadScoring';
    ...
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-center">
          ...
          <Button onClick={() => navigate('/crm/leads/assigned')}>
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          <Button
            variant="ghost"
            size="sm"
            onClick={() => navigate("/crm/leads/assigned")}
          >
