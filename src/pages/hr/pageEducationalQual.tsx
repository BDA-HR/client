...
function PageEducationalQual() {
  const [educationalQuals, setEducationalQuals] = useState<
    EducationQualListDto[]
  >([]);
  const [editingQual, setEditingQual] = useState<EducationQualModDto | null>(
    null
  );
  const [deletingQual, setDeletingQual] = useState<EducationQualListDto | null>(
    null
  );
